...
export interface PlatformDayData {
  readonly __typename?: 'PlatformDayData';
  readonly id: Scalars['ID'];
  readonly date: Scalars['Int'];
...
export interface PlatformDayData_Filter {
  readonly id?: Maybe<Scalars['ID']>;
  readonly id_not?: Maybe<Scalars['ID']>;
  readonly id_gt?: Maybe<Scalars['ID']>;
  readonly id_lt?: Maybe<Scalars['ID']>;
...
export enum PlatformDayData_OrderBy {
  Id = 'id',
  Date = 'date',
...
export interface Query {
  ...
  readonly swaps: ReadonlyArray<Swap>;
  readonly platformDayData?: Maybe<PlatformDayData>;
  readonly platformDayDatas: ReadonlyArray<PlatformDayData>;
...
export interface QueryPlatformDayDataArgs {
  id: Scalars['ID'];
  block?: Maybe<Block_Height>;
}


export interface QueryPlatformDayDatasArgs {
  skip?: Maybe<Scalars['Int']>;
  first?: Maybe<Scalars['Int']>;
  orderBy?: Maybe<PlatformDayData_OrderBy>;
  orderDirection?: Maybe<OrderDirection>;
  where?: Maybe<PlatformDayData_Filter>;
  block?: Maybe<Block_Height>;
}
...
export interface SubscriptionPlatformDayDataArgs {
  id: Scalars['ID'];
  block?: Maybe<Block_Height>;
}


export interface SubscriptionPlatformDayDatasArgs {
  skip?: Maybe<Scalars['Int']>;
  first?: Maybe<Scalars['Int']>;
  orderBy?: Maybe<PlatformDayData_OrderBy>;
  orderDirection?: Maybe<OrderDirection>;
...
export type FactoriesQuery = (
  ...
  & { readonly factories: ReadonlyArray<(
    { readonly __typename?: 'Factory' }
    & Pick<Factory, 'id' | 'totalVolumeUSD' | 'totalVolumeBNB' | 'untrackedVolumeUSD' | 'totalLiquidityUSD' | 'totalLiquidityBNB' | 'totalTransactions' | 'totalPairs'>
  )> }
);

export type CurrentFactoriesQueryVariables = Exact<{
  factoryAddress: Scalars['ID'];
}>;


export type CurrentFactoriesQuery = (
  { readonly __typename?: 'Query' }
  & { readonly factories: ReadonlyArray<(
    { readonly __typename?: 'Factory' }
    & Pick<Factory, 'id' | 'totalVolumeUSD' | 'totalVolumeBNB' | 'untrackedVolumeUSD' | 'totalLiquidityUSD' | 'totalLiquidityBNB' | 'totalTransactions' | 'totalPairs'>
